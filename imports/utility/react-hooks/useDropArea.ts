...
export interface DropAreaOptions {
    onFiles?: (files: File[], event?: SyntheticEvent) => void;
    onText?: (text: string, event?: SyntheticEvent) => void;
    onUri?: (url: string, event?: SyntheticEvent) => void;
}
...
const createBond = (
    process: (dataTransfer: DataTransfer, event: SyntheticEvent) => void,
